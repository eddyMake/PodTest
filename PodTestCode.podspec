#
#  Be sure to run `pod spec lint PodTestCode.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "lj"
  # spec.authors            = { "lj" => "287638568@qq.com" }
  # spec.social_media_url   = "https://twitter.com/lj"
